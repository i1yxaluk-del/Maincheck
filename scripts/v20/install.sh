...
LOG=${V20_INSTALL_LOG:-/var/log/ai-suggester-v20-install.log}; UNIT=ai-suggester-v20-install-${PROFILE//[^a-zA-Z0-9]/-}
...
echo "V20 INSTALL STARTED unit=$UNIT log=$LOG"; echo "journalctl -fu $UNIT"
